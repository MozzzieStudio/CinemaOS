...
- [Home](https://www.finaldraft.com/)
- [Blog](https://www.finaldraft.com/blog)
- [Script Templates](https://www.finaldraft.com/support/script-templates/)
- [Quick Start](https://www.finaldraft.com/learn/final-draft-quick-start/)
- [Manuals](https://www.finaldraft.com/support/manuals-and-software/)

### Celtx

- [Home](https://www.celtx.com)
- [Blog](https://blog.celtx.com/)
- [Celtx vs Final Draft](https://celtxmaindomain.zesty.dev/resources/celtx-vs-final-draft/)

### ComfyUI (Ecosystem)

- [Home](https://www.comfy.org/)
- [Cloud](https://www.comfy.org/cloud)
- [Enterprise](https://www.comfy.org/cloud/enterprise)
...
- [API](https://www.freepik.com/api#from_element=mainmenu)
- [AI Docs](https://www.freepik.com/ai/docs)

### Veed

- [Home](https://www.veed.io/)
- [Tools](https://www.veed.io/tools)

### LTX Studio

- [Home](https://ltx.studio/home-v2)
- [Blog](https://ltx.studio/blog)
- [Docs](https://docs.ltx.video/welcome)
- [Lightricks](https://www.lightricks.com/)

### DaVinci Resolve

- [Home](https://www.blackmagicdesign.com/es/products/davinciresolve)
- [Studio](https://www.blackmagicdesign.com/es/products/davinciresolve/studio)
- [What's New](https://www.blackmagicdesign.com/es/products/davinciresolve/whatsnew)

## 2. Tech Stack

### Rust & Tauri

- [Rust Lang (ES)](https://rust-lang.org/es/)
- [Rust Blog](https://blog.rust-lang.org/)
- [Tauri v2 (ES)](https://v2.tauri.app/es/)
- [Tauri Start](https://v2.tauri.app/es/start/)
- [Tauri GitHub](https://github.com/tauri-apps/tauri)
- [Tauri Release](https://v2.tauri.app/es/release/)
- [Tonic Docs](https://docs.rs/tonic/latest/tonic/)
- [Tonic GitHub](https://github.com/hyperium/tonic)
- [gRPC Rust Codelab](https://codelabs.developers.google.com/grpc/getting-started-grpc-rust#0)
...
- [Lexical API](https://lexical.dev/docs/api/)
...
- [Kira Docs](https://docs.rs/kira/latest/kira/#kira)
- [Kira GitHub](https://github.com/tesselode/kira)
- [CleverAudio (CLAP)](https://cleveraudio.org)
- [CLAP DB](https://clapdb.tech/)
- [OpenUSD Release](https://openusd.org/release/index.html)
- [OpenTimelineIO](https://opentimelineio.readthedocs.io/en/latest/#)
- [OpenColorIO](https://opencolorio.org/)
- [OpenColorIO Docs](https://opencolorio.readthedocs.io/en/latest/)
...
- [Gemini on GCP](https://cloud.google.com/ai/gemini)
...
- [Translate Docs](https://docs.cloud.google.com/translate/docs/overview)
...
- [Vertex AI Studio Console](https://console.cloud.google.com/vertex-ai/studio/)
...
- [Responsible AI](https://ai.google.dev/responsible/)
- [Google AI Edge](https://ai.google.dev/edge/)
- [DeepMind Gemini](https://deepmind.google/models/gemini)
- [DeepMind Gemma](https://deepmind.google/models/gemma)
...
- [Claude 4.5 News](https://platform.claude.com/docs/en/about-claude/models/whats-new-claude-4-5)
...
- [Segment Anything Demo](https://aidemos.meta.com/segment-anything)
...
- [Llama Home](https://www.llama.com/)
...
### Alibaba & Chinese Models

- [Model Studio](https://modelstudio.console.alibabacloud.com/?tab=doc#/doc)
- [Qwen 3 Max](https://modelstudio.console.alibabacloud.com/?tab=doc#/doc/?type=model&url=2840914_2&modelId=qwen3-max)
...
- [Models](https://bfl.ai/models)
- [Quick Start](https://docs.bfl.ai/quick_start/introduction)
- [HuggingFace](https://huggingface.co/black-forest-labs)
- [GitHub](https://github.com/black-forest-labs/flux)
- [Release Notes](https://docs.bfl.ai/release-notes)

### Fal.ai & Others

- [Fal.ai Docs](https://fal.ai/docs)
- [Fal.ai Serverless](https://docs.fal.ai/serverless)
- [Fal.ai Compute](https://docs.fal.ai/compute)
- [Fal.ai Platform APIs](https://docs.fal.ai/platform-apis)
- [Fal.ai Changelog](https://docs.fal.ai/changelog)
- [Flux 2 Tiny AutoEncoder](https://huggingface.co/fal/FLUX.2-Tiny-AutoEncoder)
- [Clarity AI](https://clarityai.co/)
- [Clarity API](https://clarityai.co/api)
...
- [Clerk RS](https://github.com/DarrenBaldwin07/clerk-rs)
- [Keygen](https://keygen.sh/docs/)
