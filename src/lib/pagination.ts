...
const ELEMENT_LINE_COSTS: Record<
  string,
  { base: number; charsPerLine: number }
> = {
  ...
  parenthetical: { base: 1, charsPerLine: 20 }, // Parenthetical is even narrower (2.0" @ 10cpi)
 ...
 */
export function extractElementsFromRoot(
  rootChildren: any[]
